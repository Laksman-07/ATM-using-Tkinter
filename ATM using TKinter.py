...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controller.title('ATM SYSTEM')
        self.controller.state('zoomed')
        #self.controller.iconphoto(False,tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\bc.png"))

        heading=tk.Label(self,text='ATM SYSTEM',font=('orbitron',45,'bold'),foreground='white',background='#3d3d5c')
        heading.pack(pady=25)

        space_label=tk.Label(self,height=4,bg='#3d3d5c').pack()

        password_label=tk.Label(self,text=(f'Welcome {user_display_name} to ATM SYSTEM Banking'),font=('BatmanForeverAlternate',17),bg='#3d3d5c',fg='white').pack(pady=10)
        ...
        visa_photo= tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\visa.png")
        visa_label=tk.Label(bottom_frame,image=visa_photo)
        visa_label.pack(side='left')
        visa_label.image=visa_photo

        mastercard_photo= tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\mastercard.png")
        ...
        american_express_photo= tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\american_express.png")
        ...
        credits=tk.Label(bottom_frame,text='SIMPLIFIED ATM SYSTEM',font=('orbitron',15)).pack()
    ...
    def __init__(self, parent, controller):
        ...
        def withdraw(amount):
            ...
            if amount>current_balance:
                ...
                mycursor.execute(f"update payroll set balance ={current_balance} where username = {username1} ")
                mydb.commit()
        ...
        other_amount_heading=tk.Button(button_frame,text='Other Denominations in Rupees',font=('orbitron',13),borderwidth=0,relief='sunken',activeforeground='white',activebackground='#33334d',bg='#33334d',fg='white')
...
class InfoPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        mycursor.execute("use new_schema")
        mycursor.execute(f"select password from payroll where username = {username1} ")
        pass_code=mycursor.fetchone()
        pass_code_read=''
        for i in pass_code:
            pass_code_read+=str(i)

        name_info = tk.Label(upperframe, text=f'Name : {user_display_name}', font=('orbitron',16),fg='white', bg='#33334d')
        name_info.pack(pady=5)

        username_info = tk.Label(upperframe, text=f'Account No. : {username1}', font=('orbitron',16),fg='white', bg='#33334d')
...
def about():
  ...
  screen3.configure(bg='lightsteelblue')
  screen3.iconphoto(False,tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\abc.png"))
  Label(screen3,bg='lightsteelblue', text = "CREATED BY LAKSMAN",font = ("orbitron", 10,'bold')).pack()
...
def register_user():
  ...
  mycursor.execute('select username from payroll')
  ...
  if username_info in b:
    ...
    name_entry.delete(0,END)
        ...
        name_entry.delete(0, END)
        screen1.destroy()
        mycursor.execute("insert into payroll values('"+username_info+"','"+password_info+"','"+balance_inti+"','"+name_info+"')")
        mydb.commit()
...
def login_verify():
  ...
  mydb=mysql.connector.connect(host="localhost",user="root",password="12345678",database="new_schema")
  mycursor=mydb.cursor()
  mycursor.execute("select username from payroll ")
  values=mycursor.fetchall()
  user_acc=[]
      ...
      if username1.isdigit():
          ...
          if int(username1) in user_acc:
              ...
              if password1=='':
                  ...
                  mycursor.execute(f"select username from payroll where username={username1}")
                  values=mycursor.fetchall()
                  user_name=[]
                  for i in values:
                  ...
                  mycursor.execute(f'select balance from payroll where username ={username1}')
                  values=mycursor.fetchall()
                  user_balance=[]
                  for i in values:
...
def register():
  ...
  screen1.configure(bg='lightsteelblue')
  screen1.iconphoto(False,tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\abc.png"))

  photo = PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\login_person.png")
  label = Label(screen1,image=photo,bg='lightsteelblue')
  label.image = photo
  label.pack(pady=5)
  ...
  Label(screen1, text = "Please enter details below to register",bg='lightsteelblue',font = ("orbitron", 10)).pack()

  Label(screen1, text = "",bg='lightsteelblue').pack()
  Label(screen1, text = "Name",font = ("orbitron", 10),bg='lightsteelblue').pack()
  name_entry = Entry(screen1,font = ("orbitron",10), textvariable = name)
  name_entry.pack()

  Label(screen1, text = "Account No.",font = ("orbitron", 10),bg='lightsteelblue').pack()
  rand=random.randint(1,100000)
  username=Label(screen1, text = rand,font = ("orbitron", 11),bg='lightsteelblue').pack()
 # username_entry = Entry(screen1, textvariable = username)
  #username_entry.pack()

  Label(screen1, text = "Pin",font = ("orbitron", 10),bg='lightsteelblue').pack()
  ...
  img1 = PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\register_final.png")
  photoimage1 = img1.subsample(3, 3)
  img1Btn = Button(screen1,command = register_user,image=photoimage1,bg='lightsteelblue',activebackground='lightsteelblue',relief=FLAT)
...
def login():
  ...
  screen2.configure(bg='lightsteelblue')
  screen2.iconphoto(False,tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\abc.png"))

  photo = PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\login_person.png")
  label = Label(screen2,image=photo,bg='lightsteelblue')
  label.image = photo
  label.pack(pady=5)

  Label(screen2, text = "Please enter details below to login",bg='lightsteelblue',font = ("orbitron", 10)).pack()
  Label(screen2, text = "",bg='lightsteelblue').pack()
  ...
  Label(screen2, text = "Account No.",bg='lightsteelblue',font = ("orbitron", 10)).pack()
  username_entry1 = Entry(screen2,font = ("orbitron",10) ,textvariable = username_verify)
  username_entry1.pack()

  Label(screen2, text = "",bg='lightsteelblue').pack()
  Label(screen2, text = "Pin",bg='lightsteelblue',font = ("orbitron", 10)).pack()
  password_entry1 = Entry(screen2,font = ("orbitron",10), textvariable = password_verify)
  password_entry1.config(fg='black',show='●')
  password_entry1.pack()
  Label(screen2, text = "",bg='lightsteelblue').pack()

  img1 = PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\login_final.png")
  photoimage1 = img1.subsample(3, 3)
  img1Btn = Button(screen2,command = login_verify,image=photoimage1,bg='lightsteelblue',activebackground='lightsteelblue',relief=FLAT)
  img1Btn.image = photoimage1
  img1Btn.pack()
...
def main_screen():
  ...
  screen.title("ATM SYSTEM")
  screen.configure(bg='lightsteelblue')
  screen.iconphoto(False,tk.PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\abc.png"))


  Label(text = "ATM SYSTEM",fg='white', bg = "grey", width = "300", height = "2", font = ("orbitron", 15,'bold')).pack()
  Label(text = "",bg='lightsteelblue').pack()

  img = ImageTk.PhotoImage(Image.open(r"C:\Users\laksm\OneDrive\Documents\New folder\pr_logo.png"))
  panel = Label(screen, image = img,bg='lightsteelblue')
  panel.pack()

  photo1 = PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\login_final.png")
  photoimage1 = photo1.subsample(2, 2)
  Button(command = login,bg='lightsteelblue',activebackground='lightsteelblue',relief=FLAT,image = photoimage1).pack(pady=5)

  Label(text = "",bg='lightsteelblue',).pack()

  photo2 = PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\register_final.png")
  photoimage2 = photo2.subsample(2, 2)
  Button(command = register,bg='lightsteelblue',activebackground='lightsteelblue',relief=FLAT,image = photoimage2).pack(pady=5)

  Label(text = "",bg='lightsteelblue').pack()

  #photo3 = PhotoImage(file=r"C:\Users\laksm\OneDrive\Documents\New folder\about_final.png")
  #photoimage3 = photo3.subsample(2, 2)
  #Button(command = about,bg='lightsteelblue',activebackground='lightsteelblue',relief=FLAT,image = photoimage3).pack(pady=5)
